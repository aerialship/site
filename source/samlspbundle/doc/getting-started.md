---
layout: samlspbundle
title: SamlSpBundle Getting started
---
...
Full configuration you can see at [Configuration Reference](configuration).
For details about user provider check the [User Provider](user-provider) documentation.
...
* [Certificates and Signing](certificates-and-signing)